...
def train_gpt2():
    ...
    wandb_project = 'musicbench-gpt2'
    wandb_run_name = 'first-run' # 'run' + str(time.time())
    # data
    dataset = 'musicbench-gpt2'
    ...
    data_dir = os.path.join('/my_vol', dataset)
    def get_batch(split):
        # We recreate np.memmap every batch to avoid a memory leak, as per
        # https://stackoverflow.com/questions/45132940/numpy-memmap-memory-usage-want-to-iterate-once/61472122#61472122
        # returns x: [batch_size, block_size], y: [batch_size, block_size]
        if split == 'train':
